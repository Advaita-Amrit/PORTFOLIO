...
const Home = () => {
	...
	const email = 'advaitaamrit@gmail.com';
	const whatsappNumber = '+919307553371';

	const { data: githubData } = useSWR('https://api.github.com/users/advaita-amrit', fetcher);
	...
	return (
	  ...
	  />
				...
				>
					Tech Enthusiast specializing in Digital Innovation with expertise in Web Development, Automation, and Interactive Tech.
					</motion.p>
				...
				>
					<motion.a
						href="https://github.com/Advaita-Amrit"
						target="_blank"
						rel="noopener noreferrer"
					...
					<motion.a
						href="https://www.linkedin.com/in/advaita-amrit/"
						target="_blank"
						rel="noopener noreferrer"
						className="flex flex-col items-center group w-full"
						whileHover={{ y: -2 }}
					>
						...
						<motion.div
							...
							transition={{ delay: 0.8 }}
						>
							<span className="text-base sm:text-lg font-semibold">1k+</span>
