	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'advaitaamrit@gmail.com',
			link: 'mailto:advaitaamrit@gmail.com'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Phone',
			value: '+919307553371',
			link: 'tel:+919307553371'
		},
		{
	...
	const socialLinks = [
		{
			...
			label: 'GitHub',
			link: 'https://github.com/Advaita-Amrit'
		},
		{
			icon: <Linkedin className="w-5 h-5" />,
			label: 'LinkedIn',
			link: 'https://www.linkedin.com/in/advaita-amrit/'
		},
		{
			icon: <MessageCircle className="w-5 h-5" />,
			label: 'WhatsApp',
			link: 'https://wa.me/+919307553371'
		}
	];
